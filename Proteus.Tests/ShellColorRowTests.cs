...
/// <summary>
/// <see cref="ShellColorRows.BuildRows"/> — the metadata presets turned into the 32 sub-rows a SHELL
/// material gets.
/// <para/>
...
public class ShellColorRowTests
{
    ...
    public void MaskShell_SubRowAOnly_MirrorsIntoB()
    {
        ...
        var rows = ShellColorRows.BuildRows(
    ...
    public void FabricShell_SubRowAOnly_LeavesBNeutral()
    {
        ...
        var rows = ShellColorRows.BuildRows(new List<ColorTableRowPreset> { Row(16, "#FF0000", null) })!;
    ...
    public void FabricShell_GlowOnOneSubRow_DoesNotSpreadToTheOther()
    {
        ...
        var rows = ShellColorRows.BuildRows(new List<ColorTableRowPreset>
        {
    ...
    public void NoPresets_NeutralOnlyForAMaskShell()
    {
        ...
        Assert.Null(ShellColorRows.BuildRows(null));
        Assert.Null(ShellColorRows.BuildRows(new List<ColorTableRowPreset>()));
        var mask = ShellColorRows.BuildRows(new List<ColorTableRowPreset>(), isMaskShell: true)!;
    ...
    public void TileCarriesThroughBothRowBuilders()
    {
        ...
        foreach (var rows in new[] { ShellColorRows.BuildRows(preset)!, ShellColorRows.BuildSparseRows(preset)! })
        {
